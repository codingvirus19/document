...
export default class Contents extends React.Component {
    ...
    groupByalarm(gNo) {
        if(this.props.alarm == undefined)return;
        ...
        return (
            <Fragment>
                <div className={styles.ChatBox}>
                    {(this.state.chatOpen) ? <ChatRoom gNo={this.state.gNo} gName={this.state.gName} users={this.props.users} close={this.close.bind(this)} clientRef={this.props.clientRef} /> :
                        (this.props.group.gname.map((gname, index) => {
                            return (
                                <Fragment>
                                    <div className={styles.chatList} id={index} key={index} onClick={this.open.bind(this)}>
                                        {gname}
